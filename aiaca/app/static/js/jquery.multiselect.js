...
(function($){
    var defaults = {
        ...
        texts: {
            placeholder:     'Aucune sélection', // text to use in dummy input
            search:          'Chercher',         // search input placeholder text
            selectedOptions: ' Sélectionné',      // selected suffix text
            selectAll:       'Sélectionner tout',     // select all text
            unselectAll:     'Désélectionner tout',   // unselect all text
            ...
            optionsList.find('.ms-reflow input[type="checkbox"]').each(function( idx ){
                if( $(this).css('display').match(/block$/) ) {
                    ...
                    $(this).closest('label').css(
                        'padding-left',
                        (parseInt( $(this).closest('label').css('padding-left') ) ) + checkboxWidth + 20
                    );
